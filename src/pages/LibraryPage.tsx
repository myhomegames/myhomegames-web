...
export default function LibraryPage({
  ...
  const [selectedAgeRating, setSelectedAgeRating] = useState<string | null>(() => {
    const saved = localStorage.getItem("librarySelectedAgeRating");
  ...
  // Listen for game update events to update games in library
  useGameEvents({ setGames, enabledEvents: ["gameUpdated"] });
  ...
  useEffect(() => {
    if (selectedAgeRating !== null) {
      localStorage.setItem("librarySelectedAgeRating", selectedAgeRating);
    } else {
      localStorage.removeItem("librarySelectedAgeRating");
    }
  }, [selectedAgeRating]);
